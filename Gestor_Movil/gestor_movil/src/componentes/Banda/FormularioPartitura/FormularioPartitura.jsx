...
export default function FormularioPartitura({ nidPartitura }) {
  ...
  const opcionesCategorias = categorias
    .map((cat) => ({
      valor: cat.nid_categoria,
      etiqueta: cat.nombre_categoria,
    }))
  ...
  return (
    <div className="formulario-partitura-container">
      ...
      <Boton
        texto={"Guardar"}
        onClick={() => {
          console.log("Guardando partitura con datos: ", {
          ...
          const errorRespuesta = registrarPartitura({
            nid_partitura: nidPartitura,
            titulo: titulo,
            autor: autor,
            url: url,
            nid_categoria: nidCategoria,
            url_partitura: url,
          });
      ...
      <ModalExito
        ...
        setVisible={() => {
          ...
          if (!nidPartitura) {
            console.log(
              "Navegando a la partitura recien creada con id: ",
