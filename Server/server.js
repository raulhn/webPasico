...
app.get("/obtener_titulo_menu/:id", (req, res) => {
  let id_menu = req.params.id;
  menu
...
app.post("/eliminar_menu", (req, res) => {
...
app.post("/actualizar_titulo_menu", (req, res) => {
  let id_menu = req.body.id_menu;
  let titulo = req.body.titulo;
  gestion_usuarios
    .esAdministrador(req.session.nombre)
...
app.post("/incrementa_orden", function (req, res) {
...
app.post("/decrementa_orden", function (req, res) {
  let id_pagina = req.body.id_pagina;
  let id_componente = req.body.id_componente;
...
app.get("/numero_componente_componentes/:id", (req, res) => {
  let id_componente = req.params.id;
...
app.get("/numero_componente_componentes_definidos/:id", (req, res) => {
  let id_componente = req.params.id;
...
/** IMAGENES **/
app.post("/actualizar_imagen", (req, res) => {
  gestion_usuarios
    .esAdministrador(req.session.nombre)
    .then((bEsAdministrador) => {
      if (bEsAdministrador) {
...
app.get("/ruta_imagen/:id", (req, res) => {
...
app.get("/imagen_url/:id", async (req, res) => {
...
/** Video **/
app.get("/obtiene_url_video/:id", (req, res) => {
  let id_componente = req.params.id;
  componente
...
app.get("/obtiene_url/:id", (req, res) => {
  let id_menu = req.params.id;
  menu
...
/** GALERIA **/
app.get("/obtiene_imagenes_galeria/:id", (req, res) => {
...
app.post("/add_imagen_galeria", (req, res) => {
  gestion_usuarios
    .esAdministrador(req.session.nombre)
    .then((bEsAdministrador) => {
      if (bEsAdministrador) {
...
app.post("/eliminar_imagen_galeria", (req, res) => {
  gestion_usuarios
    .esAdministrador(req.session.nombre)
    .then((bEsAdministrador) => {
      if (bEsAdministrador) {
...
app.get("/obtener_paginas_componente/:id", (req, res) => {
...
app.post("/add_pagina_componente", (req, res) => {
  gestion_usuarios
    .esAdministrador(req.session.nombre)
    .then((bEsAdministrador) => {
      if (bEsAdministrador) {
...
app.post("/remove_pagina_componente", (req, res) => {
  gestion_usuarios
    .esAdministrador(req.session.nombre)
    .then((bEsAdministrador) => {
      if (bEsAdministrador) {
