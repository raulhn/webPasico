...
alter table pasico_movil.tipo_evento_musico add constraint fk_tipo_evento_musico foreign key(nid_evento_concierto) references pasico_movil.evento_concierto(nid_evento_concierto);
