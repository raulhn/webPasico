  ...
  guardar() {
    if (this.desplegable == Constantes.TipoComponente.TEXTO) {
      this.componenteService
        .crear_componente(this.id_pagina, this.desplegable)
        .subscribe((res) => {
      ...
      this.componenteService
        .crear_componente_video(this.id_pagina, this.desplegable, this.url)
        .subscribe((res) => {
          window.location.reload();
        });
      ...
      this.componenteService
        .crear_componente_blog(this.id_pagina, this.desplegable)
        .subscribe((res: any) => {
          window.location.reload();
        });
