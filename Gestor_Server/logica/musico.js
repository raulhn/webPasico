...
async function async_registrar_instrumento_persona(
  nid_persona,
  nid_instrumento,
  nid_tipo_musico,
  resolve,
...
async function registrar_instrumento_persona(
  ...
  return new Promise((resolve, reject) => {
    async_registrar_instrumento_persona(
      nid_persona,
      nid_instrumento,
      nid_tipo_musico,
      resolve,
...
async function async_obtener_instrumentos_persona(
  nid_persona,
  resolve,
  reject
) {
...
function obtener_instrumentos_persona(nid_persona) {
  return new Promise((resolve, reject) => {
    async_obtener_instrumentos_persona(nid_persona, resolve, reject);
  });
}
...
async function async_obtener_personas_instrumento(
  nid_instrumento,
  resolve,
  reject
) {
...
function obtener_personas_instrumento(nid_instrumento) {
  return new Promise((resolve, reject) => {
    async_obtener_personas_instrumento(nid_instrumento, resolve, reject);
  });
}
