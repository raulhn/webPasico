...
async function async_registrar_evaluacion(
  nid_trimestre,
  nid_asignatura,
  nid_profesor,
  resolve,
...
async function async_registrar_evaluacion_matricula(
  nid_evaluacion,
  nid_matricula_asignatura,
  nota,
  nid_tipo_progreso,
...
function registrar_evaluacion_matricula(
  nid_evaluacion,
  nid_matricula_asignatura,
  nota,
  nid_tipo_progreso,
  ...
  return new Promise((resolve, reject) => {
    async_registrar_evaluacion_matricula(
      nid_evaluacion,
      nid_matricula_asignatura,
      nota,
      nid_tipo_progreso,
...
async function async_obtener_evaluacion_matricula_asignatura(
  nid_matricula,
  resolve,
  reject
) {
  resolve(
    await obtener_evaluacion_matricula_asginatura_tipo(nid_matricula, -1, 0)
  );
}
function obtener_evaluacion_matricula_asginatura(nid_matricula) {
  return new Promise((resolve, reject) => {
    async_obtener_evaluacion_matricula_asignatura(
      nid_matricula,
      resolve,
      reject
    );
...
async function async_obtener_evaluacion_tutor(
  nid_matricula,
  nid_trimestre,
  resolve,
  reject
...
function obtener_evaluacion_tutor(nid_matricula, nid_trimestre) {
  return new Promise((resolve, reject) => {
    async_obtener_evaluacion_tutor(
      nid_matricula,
      nid_trimestre,
      resolve,
      reject
...
async function async_generar_boletin(
  nid_matricula,
  nid_trimestre,
  resolve,
  reject
  ...
  try {
    ...
    if (evaluacion_tutor !== null) {
      ...
      let alumno = evaluacion_tutor["alumno"];
...
function generar_boletin(nid_matricula, nid_trimestre) {
  return new Promise((resolve, reject) => {
    async_generar_boletin(nid_matricula, nid_trimestre, resolve, reject);
  });
}
