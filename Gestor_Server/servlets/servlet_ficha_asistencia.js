...
function crear_ficha_asistencia(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    let nid_ficha_asistencia = await ficha_asistencia.crear_ficha_asistencia(
      nombre,
      fecha,
      nid_asignatura,
      nid_profesor
    ...
    res
      .status(200)
      .send({ error: false, nid_ficha_asistencia: nid_ficha_asistencia });
  });
}
...
function copiar_ficha_asistencia(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    let nid_nueva_ficha_asistencia =
      await ficha_asistencia.copiar_ficha_asistencia(
        nombre,
        fecha,
        nid_profesor,
    ...
    res
      .status(200)
      .send({ error: false, nid_ficha_asistencia: nid_nueva_ficha_asistencia });
  });
}
...
function obtener_fichas_asistencias(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    let fichas_asistencias = await ficha_asistencia.obtener_fichas_asistencias(
      nid_profesor
    );

    res
      .status(200)
      .send({ error: false, fichas_asistencias: fichas_asistencias });
  });
}
...
function obtener_ficha_asistencia(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    let ficha = await ficha_asistencia.obtener_ficha_asistencia(
      nid_profesor,
      nid_ficha_asistencia
    );
...
function obtener_alumnos_seleccion(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    let alumnos_seleccion =
      await ficha_asistencia.obtener_alumnos_ficha_seleccion(
        nid_ficha_asistencia,
        nid_profesor
      );
    res
      .status(200)
      .send({ error: false, alumnos_seleccion: alumnos_seleccion });
  });
}
...
function registrar_ficha_asistencia_alumno(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    await ficha_asistencia.registrar_ficha_asistencia_alumno(
      nid_ficha_asistencia,
      nid_alumno
    );
...
function eliminar_ficha_asistencia_alumno(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    await ficha_asistencia.eliminar_ficha_asistencia_alumno(
...
function obtener_fichas_asistencias_alumno(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    let resultados = await ficha_asistencia.obtener_fichas_asistencias_alumno(
      nid_ficha_asistencia
    );
    res
      .status(200)
      .send({ error: false, fichas_asistencias_alumno: resultados });
  });
}
...
function actualizar_ficha_asistencia_alumnos(req, res) {
  comun.comprobaciones_profesor(req, res, async () => {
    ...
    for (let i = 0; i < lista_fichas.length; i++) {
      await ficha_asistencia.actualizar_ficha_asistencia_alumnos(
        lista_fichas[i]["nid_ficha_asistencia_alumno"],
