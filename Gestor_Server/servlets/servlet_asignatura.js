...
function obtener_asignaturas(req, res) {
  comun.comprobaciones_general(req, res, async () => {
    let resultado_asignaturas = await asignatura.obtener_asignaturas();
...
function obtener_asignatura(req, res) {
  comun.comprobaciones(req, res, async () => {
    ...
    let resultado = await asignatura.obtener_asignatura(nid_asignatura);
...
function obtener_profesores(req, res) {
  comun.comprobaciones(req, res, async () => {
    let resultado_profesores = await asignatura.obtener_profesores();
...
function obtener_profesores_asignatura(req, res) {
  comun.comprobaciones(req, res, async () => {
    ...
    let resultado_profesores = await asignatura.obtener_profesores_asignatura(
      nid_asignatura
    );
    res.status(200).send({ error: false, profesores: resultado_profesores });
  });
...
function obtener_profesores_asginatura_curso(req, res) {
  comun.comprobaciones(req, res, async () => {
    ...
    let resultado_profesores =
      await asignatura.obtener_profesores_asignatura_curso(
        nid_asignatura,
        nid_curso
      );
    res.status(200).send({ error: false, profesores: resultado_profesores });
...
function obtener_asignaturas_profesor(req, res) {
  comun.comprobaciones(req, res, async () => {
    ...
    let resultados = await asignatura.obtener_asignaturas_profesor(
      nid_profesor
    );
