...
export class MadresPersonaComponent {
  ...
  ngOnInit(): void {
    ...
    this.personaService
      .obtener_madre(this.nid_persona)
      .subscribe(this.obtener_madre);
  }
  ...
  guardar() {
    if (this.madre === undefined) {
      this.personaService
        .registrar_madre(this.nid_persona, '')
        .subscribe(this.registrar_madre);
    } else {
      this.personaService
        .registrar_madre(this.nid_persona, this.madre)
        .subscribe(this.registrar_madre);
    }
  }
