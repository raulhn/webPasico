...
export class EvaluacionProfesorComponent implements OnInit{
  ...
  constructor(private evaluacionesService: EvaluacionService, private asignaturasService: AsignaturasService, private matriculasService: MatriculasService)
  {
  ...
  ngOnInit(): void {
    ...
    this.asignaturasService.obtener_asignaturas_rol_profesor().subscribe(this.recupera_asignaturas);
  }
  ...
  recupera_alumnos = 
  {
    next: (respuesta: any) =>
    {
      ...
      this.evaluacionesService.obtener_evaluacion_profesor(this.trimestre_seleccionado, this.asignatura_seleccionada).subscribe(this.recupera_evaluaciones);
    }
  ...
  cambia_asignatura()
  {
    ...
    this.matriculasService.obtener_matriculas_activas_profesor(this.asignatura_seleccionada).subscribe(this.recupera_alumnos);
  ...
  guardar()
  {
    this.evaluacionesService.registrar_evaluacion_profesor(this.trimestre_seleccionado, this.asignatura_seleccionada, JSON.stringify(this.lista_notas), JSON.stringify(this.lista_progreso), JSON.stringify(this.lista_matriculas),
