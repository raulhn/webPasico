...
export class FichaProfesorComponent implements OnInit {
  ...
  constructor(
    ...
    private cusosServices: CursosService,
  ...
  refrescar_alumnos = {
    next: (respuesta: any) => {
      this.$lista_alumnos.set(respuesta.alumnos);
    },
  };
  ...
  obtener_asignaturas = {
    next: (respuesta: any) => {
      ...
      this.matriculasService
        ...
        .subscribe(this.refrescar_alumnos);
      this.horarioService
        .obtener_horarios(this.nid_profesor, this.asignatura_seleccionada, '')
        .subscribe(this.recuperar_horario);
    },
  };
  ...
  ngOnInit(): void {
    ...
    this.personasService
      .obtener_persona(this.nid_profesor)
      .subscribe(this.obtener_profesor);
    this.asignaturasService
      .obtener_asignaturas_profesor(this.nid_profesor)
  ...
  registrar_horario() {
    ...
    let peticion = {
      dia: this.formulario_dia,
      hora_inicio: horario_inicio_array[0],
      minutos_inicio: horario_inicio_array[1],
      hora_fin: horario_fin_array[0],
      minutos_fin: horario_fin_array[1],
      nid_asignatura: this.asignatura_seleccionada,
      nid_profesor: this.nid_profesor,
      duracion_clase: this.duracion_clase,
    };

    this.horarioService
      .registrar_horario(peticion)
      .subscribe(this.peticion_registrar_horario);
  }
