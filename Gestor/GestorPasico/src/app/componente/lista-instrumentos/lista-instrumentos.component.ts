...
export class ListaInstrumentosComponent implements OnInit {
  ...
  $lista_instrumentos: WritableSignal<any[]> = signal([]);
  cabecera_instrumentos: any[] = [
    { title: 'Instrumento', data: 'descripcion' },
  ];
  ...
  @ViewChild('instanciaEditarInstrumento')
  instancia_editar_instrumento!: ElementRef;
  ...
  refrescar_instrumentos = {
    next: (respuesta: any) => {
      this.$lista_instrumentos.set(respuesta.instrumentos);
    },
    error: (error: any) => {
  ...
  ngOnInit(): void {
    this.musicoService
      ...
      .subscribe(this.refrescar_instrumentos);
  }
  ...
  crear_instrumento() {
    ...
    this.musicoService
      .registrar_instrumento(this.nombreInstrumento)
      .subscribe(this.peticion_registrar_instrumento);
  }
  ...
  editar_instrumento() {
    ...
    this.musicoService
      .actualizar_instrumento(
        this.instrumentoSeleccionado.nid,
        this.nombreEditarInstrumento,
      )
