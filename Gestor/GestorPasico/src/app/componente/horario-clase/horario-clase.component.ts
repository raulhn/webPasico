...
export class HorarioClaseComponent implements OnInit {
  ...
  $alumnos: WritableSignal<any[]> = signal([]);
  $id_tabla_alumnos: Signal<string> = signal('tabla_personas');
  ...
  ngOnInit(): void {
    this.horariosServices
      .obtener_alumnos_sin_asignar(this.nid_horario_clase)
      .subscribe(this.peticion_obtener_alumnos_sin_asignar);
    this.horariosServices
      .obtener_alumnos_horario_clase(this.nid_horario_clase)
      .subscribe(this.peticion_obtener_alumnos);
  }
  ...
  asignar_clase() {
    if (this.nid_matricula_asignatura_seleccionada == '') {
      ...
      let datos = {
        nid_matricula_asignatura: this.nid_matricula_asignatura_seleccionada,
        nid_horario_clase: this.nid_horario_clase,
      };
      this.horariosServices
        .asignar_horario(datos)
        .subscribe(this.peticion_asignar_clase);
    }
  }
  ...
  liberar_clase() {
    ...
    let datos = {
      ...
      nid_matricula_asignatura:
        this.nid_matricula_asignatura_tabla.nid_matricula_asignatura,
    };
    this.horariosServices
      .liberar_horario(datos)
      .subscribe(this.peticion_liberar_clase);
  }
}
