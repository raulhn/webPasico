...
export class AsignaturasService {
  ...
  actualizar_asignatura(descripcion: string, nid_asignatura: string, precio: string, tipo_asignatura: string)
  {
    let API_URL = this.url + '/actualizar_asignatura';
    return this.http.post(API_URL, {descripcion: descripcion, nid_asignatura: nid_asignatura, precio: precio, tipo_asignatura: tipo_asignatura}, {withCredentials: true});
  }
