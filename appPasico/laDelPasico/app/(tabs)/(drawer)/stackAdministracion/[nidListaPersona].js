...
export default function FichaPersona() {
  const { nidListaPersona } = useLocalSearchParams();
  const { cerrarSesion } = useContext(AuthContext);

  const { alumno, cargando, error, refrescar, lanzarRefresco } =
    useAlumnoProfesor(nidListaPersona, cerrarSesion);
      ...
      return (
        <View style={estilos.card}>
          ...
          <Text style={estilos.texto}>
            {padre.nombre} {padre.primer_apellido} {padre.segundo_apellido}
          </Text>
    ...
    if (alumno && alumno.madre) {
      ...
      return (
        <View style={estilos.card}>
          ...
          <Text style={estilos.texto}>
            {madre.nombre} {madre.primer_apellido} {madre.segundo_apellido}
          </Text>
          <Text style={estilos.label}>Correo electrónico:</Text>
    ...
    if (alumno && alumno.persona) {
      ...
      return (
        <View style={estilos.card}>
          ...
          <Text style={estilos.label}>Correo electrónico:</Text>
          <Text style={estilos.texto}>
            {alumnoRecuperado.correo_electronico}
          </Text>
          <Text style={estilos.label}>Teléfono:</Text>
